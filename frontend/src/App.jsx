...
import TasksDetails from "./pages/Tasks/TasksDetail"
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/otherprofile/:pk" element={<ProtectedRoute><OtherProfile /></ProtectedRoute>}></Route>
        ...
        <Route path="/task/:pk" element={<ProtectedRoute><TasksDetails /></ProtectedRoute>}></Route>
